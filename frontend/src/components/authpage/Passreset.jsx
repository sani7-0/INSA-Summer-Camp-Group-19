  ...
  return (
    ...
    >
      ...
      <div className="bg-gray-200 p-8 rounded-xl max-w-md w-full shadow-2xl relative">
        ...
        <button className="w-full mt-6 bg-[linear-gradient(135deg,#667eea_0%,#764ba2_100%)] hover:bg-blue-700 text-white font-semibold py-3 px-4 rounded-xl shadow-lg focus:outline-none transition duration-300">
          Send Reset Link
        </button>
      </div>
    </div>
