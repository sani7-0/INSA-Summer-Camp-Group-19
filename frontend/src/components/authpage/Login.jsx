      ...
      <div className="relative w-full max-w-4xl p-4 bg-gray-900 rounded-lg shadow-lg flex flex-col md:flex-row items-center">
        ...
        <div className="bg-white rounded-lg p-8 w-full md:w-1/2 shadow-lg">
          ...
          <form className="flex flex-col space-y-4">
            ...
            {/* Sign in Button */}
            <button className="bg-[linear-gradient(135deg,#667eea_0%,#764ba2_100%)] hover:bg-[linear-gradient(135deg,#667eea_0%,#764ba2_100%)] text-white font-semibold py-2 px-4 rounded-md transition duration-300">
              Sign in
            </button>
